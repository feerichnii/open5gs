                    ...
                    if (message->h.resource.component[3]) {
                        ...
                        ogs_assert(true ==
                            ogs_sbi_server_send_error(stream,
                                ...
                                message->h.resource.component[3], OGS_SBI_CAUSE_UNSPECIFIED_MSG_FAILURE));
                        break;
                    }
                    ...
                    if (!r)
                    {
                        ogs_assert(true ==
                            ogs_sbi_server_send_error(stream,
                                ...
                                "Invalid UE Identifier", message->h.method, OGS_SBI_CAUSE_SERVING_NETWORK_NOT_AUTHORIZED));
                    }
                    break;
